...
CREATE TABLE `DHN_RESULT_STA` (
  ...
  `send_cnt` decimal(10,0) DEFAULT NULL COMMENT '발송 Count(SMS, MMS 대기 Count 제외)',
  `send_date` varchar(255) NOT NULL COMMENT '발송일자',
  `ats_cnt` decimal(10,0) DEFAULT NULL COMMENT '알림톡 성공 Count',
  `ate_cnt` decimal(10,0) DEFAULT NULL COMMENT '알림톡 실패 Count',
  `fts_cnt` decimal(10,0) DEFAULT NULL COMMENT '친구톡 성공 Count',
  `fte_cnt` decimal(10,0) DEFAULT NULL COMMENT '친구톡 실패 Count',
  `ftis_cnt` decimal(10,0) DEFAULT NULL COMMENT '친구톡 이미지 성공 Count',
  `ftie_cnt` decimal(10,0) DEFAULT NULL COMMENT '친구톡 이미지 실패 Count',
  `ftws_cnt` decimal(10,0) DEFAULT NULL COMMENT '친구톡 와이드 성공 Count',
  `ftwe_cnt` decimal(10,0) DEFAULT NULL COMMENT '친구톡 와이드 실패 Count',
  `smss_cnt` int(11) DEFAULT NULL COMMENT 'SMS 성공 Count',
  `smsd_cnt` int(11) DEFAULT 0 COMMENT 'SMS 대기 Count',
  `smse_cnt` int(11) DEFAULT NULL COMMENT 'SMS 실패 Count',
  `lmss_cnt` int(11) DEFAULT NULL COMMENT 'LMS 성공 Count',
  `lmsd_cnt` int(11) DEFAULT 0 COMMENT 'LMS 대기 Count',
  `lmse_cnt` int(11) DEFAULT NULL COMMENT 'LMS 실패 Count',
  `mmss_cnt` int(11) DEFAULT NULL COMMENT 'MMS 성공 Count',
  `mmsd_cnt` int(11) DEFAULT 0 COMMENT 'MMS 대기 Count',
  `mmse_cnt` int(11) DEFAULT NULL COMMENT 'MMS 실패 Count',
